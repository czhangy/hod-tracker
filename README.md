...
- **Leveling** — every item category that levels up in-game (Soma's Souls, Alucard's Spells, Charlotte/Yoko's Dark Magic Scrolls, Shanoa's Glyphs, Jonathan's Sub-Weapons) is tracked with the same +/− count control instead of a plain checkbox, whether the leveling comes from collecting duplicates or from landing hits in combat.
